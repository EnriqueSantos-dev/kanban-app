...
export function ButtonSelectOrCreateBoard({
	isActive = false,
	type = 'button',
	...props
			...
			className={cn(
				'group flex h-[3.18rem] w-full max-w-[16.5rem] items-center gap-3 rounded-r-full white p-4 text-left font-bold capitalize focus:outline-none transition-colors pl-6 whitespace-nowrap',
				{
					'bg-purple text-white hover:bg-purpleHover focus:bg-purpleHover':
						isActive,
					'bg-white text-mediumGrey hover:bg-purple/10 focus:bg-purple/10 hover:text-purple dark:bg-darkGrey dark:hover:bg-white dark:hover:text-purple':
						!isActive
				}
			)}
		>
